...
@section('styles')
    <link type="text/css" rel="stylesheet" href="{{asset('assets/css/jquery.miniColors.css')}}" />
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{asset('assets/js/fabric.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/tshirtEditor.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/jquery.miniColors.min.js')}}"></script>
    <script>
    ...
    <script>
        ...
        $('#flipback').click(
            function () {
                if (valueSelect === "storage/katalog") {
                    if ($(this).attr("data-original-title") == "Show Back View") {
                        $(this).attr('data-original-title', 'Show Front View');
                        $("#tshirtFacing").attr("src", "storage/katalog");
                ...
                } else if (valueSelect === "assets/img/mens_longsleeve_front.png") {
                    if ($(this).attr("data-original-title") == "Show Back View") {
                        $(this).attr('data-original-title', 'Show Front View');
                        ...
                        $(this).attr('data-original-title', 'Show Back View');
                        $("#tshirtFacing").attr("src", "assets/img/mens_longsleeve_front.png");
                        b = JSON.stringify(canvas);
                        canvas.clear();
                        try {
                            var json = JSON.parse(a);
                ...
                } else if (valueSelect === "assets/img/mens_tank_front.png") {
                    if ($(this).attr("data-original-title") == "Show Back View") {
                        $(this).attr('data-original-title', 'Show Front View');
                        $("#tshirtFacing").attr("src", "assets/img/mens_tank_back.png");
                        a = JSON.stringify(canvas);
                        canvas.clear();
                        try {
                            var json = JSON.parse(b);
            ...
            <div class="container">
                ...
                <div class="row">
                                ...
                                <div class="tab-pane active" id="tab1">
                                    <div class="well">
                                        ...
                                        <select id="tshirttype">
                                            <option
                                            value=""
                                            selected="selected">-- Pilih Desain --</option>
                                            @foreach($desains as $desain)

                                                <option
                                                    value="{{ asset('storage/' . $desain->gambar) }}"
                                                   >{{ $desain->nama }}</option>
                                            @endforeach
                                        </select>
                                        <!--						      </p>-->
                                    ...
                                    <div class="well">
                                        ...
                                        <div id="avatarlist">
                                            <img style="cursor:pointer;" class="img-polaroid"
                                                src="assets/img/invisibleman.jpg">
                                            <img style="cursor:pointer;" class="img-polaroid"
                    ...
                    <div class="span6">
                            ...
                            <div class="clearfix">
                                <div class="btn-group inline pull-left" id="texteditor" style="display:none">
                                    ...
                                    <button id="text-bold" class="btn" data-original-title="Bold"><img
                                            src="assets/img/font_bold.png" height="" width=""></button>
                                    <button id="text-italic" class="btn" data-original-title="Italic"><img
                                            src="assets/img/font_italic.png" height="" width=""></button>
                                    <button id="text-strike" class="btn" title="Strike" style=""><img
                                            src="assets/img/font_strikethrough.png" height="" width=""></button>
                                    <button id="text-underline" class="btn" title="Underline" style=""><img
                                            src="assets/img/font_underline.png"></button>
                        ...
                        <div id="shirtDiv" class="page ml-5"
